...
const RegistroTipoPersona = () => {
    const [registroTipoPersona, setRegistroTipoPersona] = useState({
        title: "registro de tipo de persona",
    })

    const { title } = registroTipoPersona
    ...
    return (
        <>
            ...
            <main id="main" className="main">
                ...
                <PageTitle titulo={registroTipoPersona} />
