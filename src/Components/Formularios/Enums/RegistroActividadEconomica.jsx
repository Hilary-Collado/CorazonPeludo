...
const RegistroActividadEconomica = () => {
    const [registroActividadEconomica, setRegistroActividadEconomica] = useState({
        title: "registro de actividad economica",
    })

    const { title } = registroActividadEconomica
    ...
    return (
        <>
            ...
            <main id="main" className="main">
                ...
                <PageTitle titulo={registroActividadEconomica} />
